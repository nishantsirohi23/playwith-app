...
List<PlanetInfo> planets = [
  PlanetInfo(1,
      name: 'Mercury',
      iconImage: 'lib/assets/mercury.png',
      description:
  ...
  PlanetInfo(2,
      name: 'Venus',
      iconImage: 'lib/assets/venus.png',
      description:
  ...
  PlanetInfo(3,
      name: 'Earth',
      iconImage: 'lib/assets/earth.png',
      description:
  ...
  PlanetInfo(5,
      name: 'Jupiter',
      iconImage: 'lib/assets/jupiter.png',
      description:
  ...
  PlanetInfo(6,
      name: 'Saturn',
      iconImage: 'lib/assets/saturn.png',
      description:
  ...
  PlanetInfo(7,
      name: 'Uranus',
      iconImage: 'lib/assets/uranus.png',
      description:
  ...
  PlanetInfo(8,
      name: 'Neptune',
      iconImage: 'lib/assets/neptune.png',
      description:
