        ...
        children: snapshot.data!.docs.map((DocumentSnapshot document) {
          ...
          return GestureDetector(
                ...
                children: [
                  Stack(
                    children: [
                      ...
                      Container(
                        margin: const EdgeInsets.only(top: 95,left: 5,bottom: 3),
                          ...
                          children: [
                            ...
                            Container(
                              padding: const EdgeInsets.only(right: 15),
                                child: AppText(text: "View All",color: Colors.black,))
                          ],
                        )
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) =>  SeeEvent(name: data['name'],eventimage: data['eventimage'],)),
              );
            }
